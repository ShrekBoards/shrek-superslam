...
pub struct AttackMoveType {
    ...
    /// Unknown property at offset +031
    pub unknown_031: bool,
    ...
    /// Unknown property at offset +0A0
    pub unknown_0a0: f32,
...
impl SerialisedShrekSuperSlamGameObject for AttackMoveType {
    ...
    fn new(bin: &Bin, offset: usize) -> Result<AttackMoveType, Error> {
        ...
        let unknown_031 = raw[offset + 0x31] != 0;
...
impl WriteableShrekSuperSlamGameObject for AttackMoveType {
    ...
    fn write(&self, bin: &mut Bin, offset: usize) -> Result<(), Error> {
        ...
        bin.raw
            .splice(offset + 0xA0..offset + 0xA4, c.write_f32(self.unknown_0a0)?);
        bin.raw
        ...
        bin.raw[offset + 0x31] = self.unknown_031 as u8;
