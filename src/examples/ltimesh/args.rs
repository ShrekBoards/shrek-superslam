...
pub struct Config {
    pub ltimesh_path: PathBuf, // The path to the .ltimesh file
...
impl Config {
    ...
    pub fn new(args: std::env::Args) -> Result<Config, String> {
        ...
        opts.reqopt("l", "ltimesh", "path to an .ltimesh file", "object.ltimesh");
        ...
        let ltimesh = PathBuf::from(matches.opt_str("l").unwrap());
